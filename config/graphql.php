...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                // ExampleQuery::class,
                'report' => \App\GraphQL\Queries\Report\ReportQuery::class,
                'reports' => \App\GraphQL\Queries\Report\ReportsQuery::class,
                'service' => \App\GraphQL\Queries\Service\ServicesQuery::class,
                'services' => \App\GraphQL\Queries\Service\ServicesQuery::class,
                'serviceType' => \App\GraphQL\Queries\ServiceType\ServiceTypeQuery::class,
                'serviceTypes' => \App\GraphQL\Queries\ServiceType\ServiceTypesQuery::class,
            ],
            'mutation' => [
                // ExampleMutation::class,
                'createReport' => \App\GraphQL\Mutations\Report\CreateReportMutation::class,
                'updateReport' => \App\GraphQL\Mutations\Report\UpdateReportMutation::class,
                'deleteReport' => \App\GraphQL\Mutations\Report\DeleteReportMutation::class,
            ],
    ...
    'types' => [
        ...
        'ServiceType' => \App\GraphQL\Types\ServiceTypeType::class,
    ],
